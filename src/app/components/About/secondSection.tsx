...
import classes from "@/app/styles/components/About/secondSection.module.scss";
...
export default function SecondSection() {
  ...
  return (
    <section className={classes.section}>
        ...
        <div className={classes.heading}>Pursuing Dreams, Building a Family,and Embracing Motherhood</div>
