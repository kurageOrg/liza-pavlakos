...
const Modal = ({ isOpen, onClose, videoLink }: { isOpen: boolean; onClose: () => void; videoLink: string; }) => {
...
const SecondSection: React.FC = () => {
  ...
  const data = [
    {
      ...
      imageSrc: "liza1.jpeg",
      heading:
        "LIZA PAVLAKOS - Speaker on Leadership and Mental Resilience",
      description:
        ...
        videoLink: "https://www.youtube.com/embed/YhFDXHyp9sM?si=Qk9MKNUcZOLYCuFx",
    ...
    },
    {
      ...
      description:
        ...
        videoLink: "https://www.youtube.com/embed/R4gBa00p0RM?si=ZoyObM9eg9qNKM4u",
      ...
      },
    {
      ...
      imageSrc: "liza4.jpeg",
      heading:
        "MESSAGE OF HOPE | Liza Pavlakos — Global Pandemic",
      description:
        ...
        videoLink: "https://www.youtube.com/embed/3BE6gsG5M9U?si=c0Ssi_Cc_7P3UAaP",
      },
    {
      id: 5,
      imageSrc: "liza5.jpeg",
      ...
      description:
        ...
        videoLink: "https://www.youtube.com/embed/L8oZJaV2ZR8?si=JmC8G9Zi5svWaxfi",
      },
    {
      id: 6,
      imageSrc: "liza6.jpeg",
      heading: "Liza Pavlakos Story - Beyond Survival",
      description:"Together, we can make a difference.|||The Liza Pavlakos Foundation is a registered charity with the Australian Charities and Not-for-Profits Commission (ACNC).|||Liza’s early life was challenging, but today she uses her story to help o...",
        videoLink: "https://www.youtube.com/embed/joLz7IYDwiA?si=N_GCnGQADymjgkIl",
    ...
    },
    {
      ...
      imageSrc: "liza7.jpeg",
      heading:
        "FOR BETTER LIVES | The Liza Pavlakos Foundation",
      description:"Life in the modern world can be stressful, confusing and challenging even when things are going well, but what happens when forces beyond your control intervene and take you on a dark journey with no escape?|||That’s exactly what has happened to Liza Pavlakos more than once, yet she has survived, and even thrived in the modern world. For her, it... ",
        videoLink: "https://www.youtube.com/embed/yn_4BxQptYc?si=gsIshOziIBiXxmy5",
    },
    {
      id: 8,
      imageSrc: "liza8.jpeg",
    ...
    },
    {
      ...
      description:
        ...
        videoLink: "https://www.youtube.com/embed/CKEweJ446Ek?si=bvAJs6ObruqOrtJM",
    },
    {
      id: 10,
      imageSrc: "liza10.jpeg",
      heading:
        "HOW TO STAY RESILIENT ON YOUR OWN - Liza Pavlakos Motivation",
      description:
        "Explore the world of motivation and empowerment with Liza Pavlakos, a highly sought-after and accomplished speaker, founder of Mind Hub Directory, and author of the compelling novel Conviction. Recognized with Toastmasters' Golden Gavel Award, Liza is ranked among the Top 10 Female Speakers in the World by Real Leaders. Her impactful work includes being the 8th globally ranked speaker in Suicide Prevention... ",
        videoLink: "https://www.youtube.com/embed/2uKyqYoDAiM?si=hamONDy5P9q-YLpV",
    },
    {
      id: 11,
      imageSrc: "liza11.jpeg",
      heading: "Mastering the Art of Manifestation- Liza Pavlakos- International Keynote Speaker",
      description:
        ...
        videoLink: "https://www.youtube.com/embed/lkiv1yVkKW4?si=uSNbGClMMSylzJba",
    },
    {
      id: 12,
      ...
      description:
        "Explore the world of motivation and empowerment with Liza Pavlakos, Founder of Mind Hub Directory—a mental health directory that strives to make a positive impact. Liza is a highly sought-after and accomplished speaker, as well as the author of the compelling novel Conviction. Recognized with Toastmasters' Golden Gavel Award, she is ranked among the Top 10 Female Speakers in the World by Real Lead...",
        videoLink: "https://www.youtube.com/embed/DGY3z-Rk20Q?si=NOY8ucOWqVxm_FCF",
    },
    {
      id: 13,
      ...
      description:
        ...
        videoLink: "https://www.youtube.com/embed/5PKkyGts9Is?si=6vos-I-IHvrIdtPI",
    },
    {
      id: 14,
      imageSrc: "liza14.jpeg",
      heading: "Best Speaker Mini Showreel. LIZA PAVALKOS. Beyond Survival. Resilience.",
      description:
        "Explore the world of motivation and empowerment with Liza Pavlakos, Founder of Mind Hub Directory—a mental health directory that strives to make a positive impact. Liza is a highly sought-after and accomplished speaker, as well as the author of the compelling novel Conviction. Recognized with Toastmasters' Golden Gavel Award, she is ranked among the Top 10 Female Speakers in the World by Real Lead...",
        videoLink: "https://www.youtube.com/embed/T68bg-eTsPQ?si=fBg0k2CHL85mLI6Q",
    },
    {
      id: 15,
      ...
      description:
      "Explore the world of motivation and empowerment with Liza Pavlakos, Founder of Mind Hub Directory—a mental health directory that strives to make a positive impact. Liza is a highly sought-after and accomplished speaker, as well as the author of the compelling novel Conviction. Recognized with Toastmasters' Golden Gavel Award, she is ranked among the Top 10 Female Speakers in the World by Real Lead...",
      videoLink: "https://www.youtube.com/embed/T68bg-eTsPQ?si=CJrl_GArM5NYEHLC",
    },
    {
      id: 16,
      ...
      description:
      "Explore the world of motivation and empowerment with Liza Pavlakos, Founder of Mind Hub Directory—a mental health directory that strives to make a positive impact. Liza is a highly sought-after and accomplished speaker, as well as the author of the compelling novel Conviction. Recognized with Toastmasters' Golden Gavel Award, she is ranked among the Top 10 Female Speakers in the World by Real Lead...",
      videoLink: "https://www.youtube.com/embed/SH3EC5t3IPE?si=2E-ajAimgW0DxzrJ",
    },
    {
      id: 17,
      imageSrc: "liza17.jpeg",
      heading: "How To Focus On The Good Things In Life. Liza Pavlakos Motivation",
      description:
      "Explore the world of motivation and empowerment with Liza Pavlakos, Founder of Mind Hub Directory—a mental health directory that strives to make a positive impact. Liza is a highly sought-after and accomplished speaker, as well as the author of the compelling novel Conviction. Recognized with Toastmasters' Golden Gavel Award, she is ranked among the Top 10 Female Speakers in the World by Real Lead...",
  ...
  return (
    <section className={`${classes.section}`}>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} videoLink={selectedVideo} />
    </section>
  );
};
