...
import classes from "@/app/styles/components/CorporateShowreel/firstSection.module.scss";
  ...
  return (
    <section className={classes.section}>
      <div className={classes.top}>
        <div className={classes.heading}>Corporate Showreel</div>
      </div>
      <div className={`${classes.videoSection} container`}>
        ...
        >
          <source
            src="assets/Images/corporateShowreel/LIZA_PAVLAKOS_KEYNOTE_SHOWREEL_ AN_ENTREPRENUER'S_JOURNEY.mp4"
            type="video/mp4"
          />
        </video>
      ...
      <div  className={`${classes.bottom} container`}>
        <div className={classes.heading}>
          Liza Pavlakos - Motivational, Inspirational, and Leadership Speaker.
        </div>
        <div  className={classes.dec}>
          <p>
            Liza Pavlakos Showreel - Motivational, Inspirational, and Leadership
            Speaker.
          </p>
          <p>
            Experience Liza Pavlakos' captivating keynote speaker showcase as
            she journeys across the globe, igniting inspiration one individual
            at a time. Through a compelling narrative of empowerment and
            self-transformation, she advocates for leadership and encourages
            positive change. This video is speaker bureau friendly.
          </p>
        </div>
      </div>
