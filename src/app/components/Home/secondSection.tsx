...
import classes from "@/app/styles/components/Home/secondSection.module.scss";
...
export default function SecondSection() {
  ...
  const toggleModal = () => {
    setModalOpen((prevModalOpen) => {
      ...
      if (videoRef.current) {
        if (newModalState) {
          // When the modal opens, mute and pause the video
          videoRef.current.muted = true;
          // videoRef.current.pause();
          setMuted(true);
        } else {
          // Restore states when modal closes
  ...
  // This effect ensures the video is muted/unmuted as per the current state
  useEffect(() => {
    if (videoRef.current) {
      videoRef.current.muted = isMuted;
    }
    ...
    <section className={classes.section}>
      <div className={`${classes.videoSection} container`}>
        ...
        <div className={classes.coverImage}>
          <Image
            src="https://kurage-assets.s3.ap-south-1.amazonaws.com/lizapavlakos/liza-keynote-speaker-video-cover-mobile.jpg?response-content-disposition=inline&X-Amz-Security-Token=IQoJb3JpZ2luX2VjENT%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FwEaCmFwLXNvdXRoLTEiRjBEAiAa1UOWfQUj8Sf%2BkBx0dZHpLDzjnuyHXVkY7z2BA7SyxwIgTB5b%2Fg0HAF17GRCzJyydCP0%2Bh3WPxYoryo88SQMx%2FpEq%2FQIIbRAEGgw2MTE0MjYxNzQ4NzgiDPwk209niFxd1iSSpiraAsjZP2bArV2FSJwEabelXPDGeHcTZWZASv%2FdRchB1ZwKYunqaimckZsHTSKV89%2BabGznEcY6VbZJ3kHJAYuTiQ37dOvjCHvelBe1W%2BiMywvaCarIHlZN9owSEGS5GqCRTZhZZUlesIdjuf%2BaTtcO4bmvrYBHsJ97txt6jWd2KRl774siYlezoKPSdrOatjIsc%2FAJNn3TP8wpKon9H87H5TcYganxI1xlMq8pa5CF2xHV%2FitpKGogT6LDt127wbGQ0Ro1ZqJwRIf9aIMvC5n%2F7j%2BV58JxWwbsujjpmorcHdS7%2F5t1KalNQMMTpWUoTpRgpqnuV6TWWCssOMFGrNhqdhFAMJvYHpkcQNTHrenMPE0a%2F7YebFDGG%2FgxuxysM6Hl733M%2BI47S9INxXL%2BdRicpEGo%2B7o%2BPb7ay11hpEkc98lNgfP0Bp7ID%2BT0IWL5IfekBh0Rt5pKYSjdTB4whbOkswY6tAKIoLwioz99MeiYGiKyuAwsCOMNn%2FZLpklggex6NINfPLeoYUyLnpptcfvAIF4sN7vc3gJuP7TCyYt0sFTE%2FDpBpRKrxgTDw2CIeCGO%2BaKtEc12xL%2FzxjgcOc1UcOyIPtpyR1SUi9DAszMJdKknhn89L8TpqXXzw%2FxEb%2B%2BJ6bnshFPSpcn1vJ04uTCQHc%2F5W05pSwwOE2vKY%2BSYSbJPre6wVXVg%2F24srsBFKygSfCYGAtBAFJqCknxwoBQhL%2BDPihUBV18hMAD3mgqrTIpAdIKBwjKw0NPqrmpwspiVHkF6SkptaUZRJbR8V6CYEUvj8jA9uri4rvsRwGyjTLrpcCfZiLBjdh%2Bp6DPQlTBgn267HQisCkGxHLBYqWZVS%2FydZikRwRtkEWlWwhReIHewVpGnwrhi%2FA%3D%3D&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20240612T041142Z&X-Amz-SignedHeaders=host&X-Amz-Expires=300&X-Amz-Credential=ASIAY4W6XA6PANLD4FQP%2F20240612%2Fap-south-1%2Fs3%2Faws4_request&X-Amz-Signature=1b97ff61829bcce5419759f536f713fee9b2efd7dde556815cec65b211d1aecd"
            alt="Cover Image"
            layout="fill"
            className={classes.coverImageMob}
          />
          <Image
            src="https://kurage-assets.s3.ap-south-1.amazonaws.com/lizapavlakos/liza-keynote-speaker-video-cover.jpg?response-content-disposition=inline&X-Amz-Security-Token=IQoJb3JpZ2luX2VjENT%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FwEaCmFwLXNvdXRoLTEiRjBEAiAa1UOWfQUj8Sf%2BkBx0dZHpLDzjnuyHXVkY7z2BA7SyxwIgTB5b%2Fg0HAF17GRCzJyydCP0%2Bh3WPxYoryo88SQMx%2FpEq%2FQIIbRAEGgw2MTE0MjYxNzQ4NzgiDPwk209niFxd1iSSpiraAsjZP2bArV2FSJwEabelXPDGeHcTZWZASv%2FdRchB1ZwKYunqaimckZsHTSKV89%2BabGznEcY6VbZJ3kHJAYuTiQ37dOvjCHvelBe1W%2BiMywvaCarIHlZN9owSEGS5GqCRTZhZZUlesIdjuf%2BaTtcO4bmvrYBHsJ97txt6jWd2KRl774siYlezoKPSdrOatjIsc%2FAJNn3TP8wpKon9H87H5TcYganxI1xlMq8pa5CF2xHV%2FitpKGogT6LDt127wbGQ0Ro1ZqJwRIf9aIMvC5n%2F7j%2BV58JxWwbsujjpmorcHdS7%2F5t1KalNQMMTpWUoTpRgpqnuV6TWWCssOMFGrNhqdhFAMJvYHpkcQNTHrenMPE0a%2F7YebFDGG%2FgxuxysM6Hl733M%2BI47S9INxXL%2BdRicpEGo%2B7o%2BPb7ay11hpEkc98lNgfP0Bp7ID%2BT0IWL5IfekBh0Rt5pKYSjdTB4whbOkswY6tAKIoLwioz99MeiYGiKyuAwsCOMNn%2FZLpklggex6NINfPLeoYUyLnpptcfvAIF4sN7vc3gJuP7TCyYt0sFTE%2FDpBpRKrxgTDw2CIeCGO%2BaKtEc12xL%2FzxjgcOc1UcOyIPtpyR1SUi9DAszMJdKknhn89L8TpqXXzw%2FxEb%2B%2BJ6bnshFPSpcn1vJ04uTCQHc%2F5W05pSwwOE2vKY%2BSYSbJPre6wVXVg%2F24srsBFKygSfCYGAtBAFJqCknxwoBQhL%2BDPihUBV18hMAD3mgqrTIpAdIKBwjKw0NPqrmpwspiVHkF6SkptaUZRJbR8V6CYEUvj8jA9uri4rvsRwGyjTLrpcCfZiLBjdh%2Bp6DPQlTBgn267HQisCkGxHLBYqWZVS%2FydZikRwRtkEWlWwhReIHewVpGnwrhi%2FA%3D%3D&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20240612T041110Z&X-Amz-SignedHeaders=host&X-Amz-Expires=300&X-Amz-Credential=ASIAY4W6XA6PANLD4FQP%2F20240612%2Fap-south-1%2Fs3%2Faws4_request&X-Amz-Signature=80a6dc446aa805278b3959a047cae8f3a728d3f3d1686deacfaf4515e76cc17c"
            alt="Cover Image"
            layout="fill"
        ...
        {!videoPlaying && (
          <button onClick={toggleModal} className={classes.playbtn}>
            <svg
              width="91"
              height="91"
              viewBox="0 0 91 91"
        ...
        {videoPlaying && (
          <>
            ...
            >
              <source
                src="assets/Images/Section_2/lizaFirstvideo.mp4"
                type="video/mp4"
              />
            </video>
      ...
      <div className={classes.bottom}>
        ...
        <div className={classes.dec}>
          International Keynote Speaker on Leadership and Mental Resilience
        </div>
      </div>
      ...
      {isModalOpen && (
        <div className={classes.modal} onClick={toggleModal}>
          <iframe
            src="https://www.youtube.com/embed/vOjz6Q_LXuM?si=S4k3kZTAwe3zotui&autoplay=1"
            frameBorder="0"
